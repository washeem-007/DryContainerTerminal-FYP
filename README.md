...
# PortZen — Digital Dry Container Terminal Management System
...
*   **Intelligent Yard Routing:** A "First-Available" algorithm that automatically assigns containers to Weigh Bays, Inspection Bays, or Stacks based on real-time occupancy and clearance status.
...
## Quick Start (Supervisor Evaluation Guide)

This project is fully containerized to ensure a consistent environment. The system handles database initialization and data seeding automatically upon startup.
...
### Azure deployment 
The system is deployed in AzureVM and can be accessed using the following link. 
*   **Web Dashboard:** [http://localhost:5173](http://localhost:5173)
